<h1 class="text-center my-5 display-4 font-weight-bold text-uppercase text-primary">Bienvenido al control de eventos de lluvias del Ejército de Guatemala</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card text-center shadow-lg border-0 rounded-lg" style="background: linear-gradient(135deg, #ffc107 0%, #ff7b00 100%);">
                    ...
                    <div class="card-body text-white">
                        <p class="card-text">Su acceso como D5 le permite ver estadisticas y mapas</p>
                    </div>
                    <div class="card-footer text-light border-0">
                        Desde su calidad de D5, usted cuenta con los accesos a ver estadísticas y mapa a nivel nacional.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card text-center shadow-lg border-0 rounded-lg" style="background: linear-gradient(135deg, #dc3545 0%, #ff5e72 100%);">
                    ...
                    <div class="card-body text-white">
                        ...
                        <p class="card-text">Control operacional de eventos catastroficos</p>
                    </div>
                    <div class="card-footer text-light border-0">
                        Desde su calidad de administrador, usted cuenta con los accesos a ver estadísticas, estados operacionales y mapa a nivel nacional.
                    </div>
                </div>
            </div>
        </div>
